; Generated by mcheisenberg.config (python) at 2026-01-11 14:23:06.852319
OPTION CASEMAP:NONE
...
nodes	dq 0.0, 1.0, 0.0, 0.0  ; nodes[0]: id="0"
		...
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[2]: id="2"
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[3]: id="3"
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[4]: id="4"
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[5]: id="5"
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[6]: id="6"
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[7]: id="7"
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[8]: id="8"
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[9]: id="9"
NODES ENDS
...
; struct edge_region {
; }
SIZEOF_EDGE_REGION  EQU 32*({offset32})EDGE_REGION_COUNT EQU 0
...
prng_state dq	000000000000000c8h,	09a831128a1905564h,	0725c4f1b715da9f6h,	06292eea56e50343fh,
				03f13f4e3c8c592c9h,	017e1c264b291a4c3h,	024f19348d57ffbcch,	0bc7bbe500b328ac6h,
				0a765439124f7d3d9h,	0407499bee49c31bch,	0e87237e4ed1fa646h,	05c026493ae04e9fdh,
				0488703a3450a425ah,	02d31dc8667ea22a9h,	07426caf738a2cafch,	03440b315da372ee5h
PRNG ENDS
