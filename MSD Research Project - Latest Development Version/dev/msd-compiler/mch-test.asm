; Generated by mcheisenberg.config (python) at 2026-01-14 11:46:17.024486
OPTION CASEMAP:NONE
...
MUTABLE_NODE_COUNT   EQU 10
IMMUTABLE_NODE_COUNT EQU 0
NODE_COUNT           EQU 10

NODES SEGMENT ALIGN(32)  ; AVX-256 (i.e. 32-byte) alignment
nodes	dq 0.0, 1.0, 0.0, 0.0  ; nodes[0]: id="0" in ['L']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[1]: id="1" in ['L']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[2]: id="2" in ['L']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[3]: id="3" in ['L']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[4]: id="4" in ['L']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[5]: id="5" in ['R']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[6]: id="6" in ['R']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[7]: id="7" in ['R']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[8]: id="8" in ['R']
		dq 0.0, 1.0, 0.0, 0.0  ; nodes[9]: id="9" in ['R']
NODES ENDS
...
; struct edge {
;	double J, Je1, Jee, b;  // 32 bytes. unused fields ignored.
; }
OFFSETOF_J   EQU 32*(0) + 8*(0)
SIZEOF_EDGE  EQU 32*(1)
EDGE_COUNT EQU 9

EDGES SEGMENT ALIGN(32)
edges	dq -1.0, 0.0, 0.0, 0.0  ; edges[0]: 0 -> 1 in [('L', 'L')]
		dq 0.0, 0.0, 0.0, 0.0  ; edges[1]: 1 -> 2 in [('L', 'L')]
		dq 0.0, 0.0, 0.0, 0.0  ; edges[2]: 2 -> 3 in [('L', 'L')]
		dq 0.0, 0.0, 0.0, 0.0  ; edges[3]: 3 -> 4 in [('L', 'L')]
		dq 0.0, 0.0, 0.0, 0.0  ; edges[4]: 4 -> 5 in [('L', 'R')]
		dq 0.0, 0.0, 0.0, 0.0  ; edges[5]: 5 -> 6 in [('R', 'R')]
		dq 0.0, 0.0, 0.0, 0.0  ; edges[6]: 6 -> 7 in [('R', 'R')]
		dq 0.0, 0.0, 0.0, 0.0  ; edges[7]: 7 -> 8 in [('R', 'R')]
		dq -1.0, 0.0, 0.0, 0.0  ; edges[8]: 8 -> 9 in [('R', 'R')]
EDGES ENDS
...
kTref	dq L + OFFSETOF_REGION_kT  ; nodes[0] -> &L.kT (region)
		dq L + OFFSETOF_REGION_kT  ; nodes[1] -> &L.kT (region)
		dq L + OFFSETOF_REGION_kT  ; nodes[2] -> &L.kT (region)
		dq L + OFFSETOF_REGION_kT  ; nodes[3] -> &L.kT (region)
		dq L + OFFSETOF_REGION_kT  ; nodes[4] -> &L.kT (region)
...
deltaU_0 PROC  ; node[0]
	...
	vmovapd ymm3, ymmword ptr [L + OFFSETOF_REGION_A]  ; load A_L (region)
	...
	; [load group 1]
	vmovsd xmm3, qword ptr [edges + (0)*SIZEOF_EDGE + OFFSETOF_J]  ; load J_0_1
	; edges[0]: 0 -> 1
...
deltaU_3 PROC  ; node[3]
	...
	vfmadd231sd xmm0, xmm3, xmm9  ; xmm0 += xmm3 * xmm9
	; edges[3]: 3 -> 4
	vmovapd ymm8, ymmword ptr [nodes + (4)*SIZEOF_NODE + OFFSETOF_SPIN]  ; load s_4 (neighbor)
	_vdotp xmm9, ymm9, ymm6, ymm8, xmm10  ; (ymm6, ymm8)
	vfmadd231sd xmm0, xmm3, xmm9  ; xmm0 += xmm3 * xmm9
...
deltaU_4 PROC  ; node[4]
	...
	vfmadd231sd xmm0, xmm3, xmm9  ; xmm0 += xmm3 * xmm9
	; edges[4]: 4 -> 5
	vmovapd ymm8, ymmword ptr [nodes + (5)*SIZEOF_NODE + OFFSETOF_SPIN]  ; load s_5 (neighbor)
	_vdotp xmm9, ymm9, ymm6, ymm8, xmm10  ; (ymm6, ymm8)
	vfmadd231sd xmm0, xmm3, xmm9  ; xmm0 += xmm3 * xmm9
...
deltaU_6 PROC  ; node[6]
	...
	vmulsd xmm0, xmm3, xmm9
	; edges[6]: 6 -> 7
	vmovapd ymm8, ymmword ptr [nodes + (7)*SIZEOF_NODE + OFFSETOF_SPIN]  ; load s_7 (neighbor)
	_vdotp xmm9, ymm9, ymm6, ymm8, xmm10  ; (ymm6, ymm8)
	vfmadd231sd xmm0, xmm3, xmm9  ; xmm0 += xmm3 * xmm9
...
deltaU_7 PROC  ; node[7]
	...
	vmulsd xmm0, xmm3, xmm9
	; edges[7]: 7 -> 8
	vmovapd ymm8, ymmword ptr [nodes + (8)*SIZEOF_NODE + OFFSETOF_SPIN]  ; load s_8 (neighbor)
	_vdotp xmm9, ymm9, ymm6, ymm8, xmm10  ; (ymm6, ymm8)
	vfmadd231sd xmm0, xmm3, xmm9  ; xmm0 += xmm3 * xmm9
...
deltaU_8 PROC  ; node[8]
	...
	vmulsd xmm0, xmm3, xmm9
	; [load group 2]
	vmovsd xmm3, qword ptr [edges + (8)*SIZEOF_EDGE + OFFSETOF_J]  ; load J_8_9
	; edges[8]: 8 -> 9
	vmovapd ymm8, ymmword ptr [nodes + (9)*SIZEOF_NODE + OFFSETOF_SPIN]  ; load s_9 (neighbor)
	_vdotp xmm9, ymm9, ymm6, ymm8, xmm10  ; (ymm6, ymm8)
	vfmadd231sd xmm0, xmm3, xmm9  ; xmm0 += xmm3 * xmm9
